    ...
    return Scaffold(
      ...
      body: Column(
        children: [
                    ...
                    child: Column(
                      children: [
                        ...
                        CircleAvatar(
                          ...
                          child: Text(
                            displayName.isNotEmpty ? displayName[0].toUpperCase() : 'T', // Display first letter in uppercase
                            style: TextStyle(fontSize: 28, color: Colors.white),
                          ),
                        ),
                        const SizedBox(height: 10),
                        Text(
                          displayName.isEmpty ? 'Loading...' : displayName, // Display user's name or loading text
                ...
                Positioned(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 16),
                      _interactiveIcon(Icons.bar_chart, "Stats", onTap: _navigateToStats), // Pass the navigation function
                    ],
                  ),
                ),
              ],
          ...
          if (selectedToggle == 0) ...[
            const Text('No items in wardrobe.', style: TextStyle(color: Colors.grey)),
            const Text('Tap the blue + button to add items.', style: TextStyle(color: Colors.grey)),
          ] else ...[
            const Text('No outfits created yet.', style: TextStyle(color: Colors.grey)),
            const Text('Tap the blue + button to create one.', style: TextStyle(color: Colors.grey)),
          ],
        ],
      ),
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          // TODO: Add item or outfit action
        },
          ...
          Expanded(
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: selectedToggle == 0 ? Colors.blueAccent : Colors.transparent,
          ...
          Expanded(
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                padding: const EdgeInsets.symmetric(vertical: 8),
                decoration: BoxDecoration(
                  color: selectedToggle == 1 ? Colors.blueAccent : Colors.transparent,
                  borderRadius: BorderRadius.circular(16),
                ),
                alignment: Alignment.center,
                child: Text(
